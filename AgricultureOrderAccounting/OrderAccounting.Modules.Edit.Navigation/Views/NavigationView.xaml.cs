...
namespace OrderAccounting.Modules.Edit.Navigation.Views
{
    /// <summary>
    ...
    public partial class NavigationView : UserControl, INavigationView
    {
        ...
        public static readonly RoutedEvent ShowViewEvent = EventManager.RegisterRoutedEvent("ShowView", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(NavigationView));

        public static readonly RoutedEvent HideViewEvent = EventManager.RegisterRoutedEvent("HideView", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(NavigationView));
