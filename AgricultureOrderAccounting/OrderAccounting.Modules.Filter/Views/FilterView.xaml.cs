...
namespace OrderAccounting.Modules.Filter.Views
{
    /// <summary>
    ...
    public partial class FilterView : UserControl, IFilterView
    {
        ...
        public static readonly RoutedEvent ShowViewEvent = EventManager.RegisterRoutedEvent("ShowView", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(FilterView));

        public static readonly RoutedEvent HideViewEvent = EventManager.RegisterRoutedEvent("HideView", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(FilterView));
